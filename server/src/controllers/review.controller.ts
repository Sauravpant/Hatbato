...
import { getAverage, getStats, handleCreateReview, handleDeleteReview, handleUpdateReview, userReviewed, userReviews } from "../services/review.services.ts";
...
export const deleteReview = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<Response> => {
  ...
  return res.status(204).json(new ApiResponse(204, {}, "Review deleted successfully"));
});
